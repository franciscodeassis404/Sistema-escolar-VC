        ...
        <div className="grid grid-cols-12 gap-6 h-[calc(100%-8rem)]">
          ...
          <div className="col-span-3 h-full">
            <div className="bg-card dark:bg-gray-800 rounded-2xl shadow-sm border border-border p-6 flex flex-col items-center h-full">
              ...
              <p className="text-sm text-muted-foreground mb-3">{professor.turma}</p>
            ...
            <div className="bg-card dark:bg-gray-800 rounded-2xl shadow-sm border border-border p-6">
              ...
              <div className="grid grid-cols-3 gap-8">
                <div>
                  ...
                  <p className="text-base font-semibold text-foreground">{professor.idade} anos</p>
                </div>

                <div>
                  <p className="text-xs text-muted-foreground mb-1">Turma</p>
                  <p className="text-base font-semibold text-foreground">{professor.turma}</p>
                </div>

                <div></div>

                <div>
                  <p className="text-xs text-muted-foreground mb-1">ID aluno</p>
                  <p className="text-base font-semibold text-foreground">{professor.id}</p>
                </div>
